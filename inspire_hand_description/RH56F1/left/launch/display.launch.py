...
def generate_launch_description():
    ...
    default_xacro_path = os.path.join(description_pkg, "RH56F1", "left", "urdf", "RH56F1_L.xacro")
    default_rviz_config_path = os.path.join(description_pkg, "RH56F1", "left", "rviz", "left.rviz")
